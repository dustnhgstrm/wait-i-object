...
myCodeImmersivesObj.term1 = 1;
delete myCodeImmersivesObj.term;
...
const myNewObject = {
  itsTrue: true,
  itsFalse: false,
  myString: "This should do",
  myOneNumber: 43,
  myArrayNumbers: [1, 2, 3],
  "pre populated str key": "I think this meets the req.",
};
